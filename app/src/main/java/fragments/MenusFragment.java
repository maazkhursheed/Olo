...
//
//        MenusItem menus = new MenusItem("BBQ : Mastana", "Spicy Hot",);
//        menuList.add(menus);
//
//        menus = new MenusItem("Chicken : Mastana", "Spicy Hot", "2015");
//        menuList.add(menus);

//        menus = new models.Menus("Beef : Mastana", "Spicy Hot", "2015");
//        menuList.add(menus);
//
//        menus = new models.Menus("Mutton : Mastana", "Spicy Hot", "2015");
//        menuList.add(menus);
//
//        menus = new models.Menus("Chicken : Mastana", "Spicy Hot", "2015");
//        menuList.add(menus);
//
//        menus = new models.Menus("Beef : Mastana", "Spicy Hot", "2015");
//        menuList.add(menus);
...
//                //Toast.makeText(getActivity(),"your cart value"+totalprice,Toast.LENGTH_SHORT).show();
//
//            }
//        }
//    }
